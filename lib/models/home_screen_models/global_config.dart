...
class GlobalConfig {
  ...
  factory GlobalConfig.fromJson(Map<String, dynamic> json) => GlobalConfig(
        randomSongsListid: json['random_songs_listid'] == null
            ? null
            : RandomSongsListid.fromJson(
                json['random_songs_listid'] as Map<String, dynamic>),
        weeklyTopSongsListid: json['weekly_top_songs_listid'] == null
            ? null
            : WeeklyTopSongsListid.fromJson(
                json['weekly_top_songs_listid'] as Map<String, dynamic>),
      );
