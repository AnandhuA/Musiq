...
class Modules {
	...
	factory Modules.fromJson(Map<String, dynamic> json) => Modules(
				...
				currentlyTrending: json['currently_trending'] == null
						? null
						: CurrentlyTrending.fromJson(json['currently_trending'] as Map<String, dynamic>),
				...
				topAlbumsFromSameYear: json['top_albums_from_same_year'] == null
						? null
						: TopAlbumsFromSameYear.fromJson(json['top_albums_from_same_year'] as Map<String, dynamic>),
			);
